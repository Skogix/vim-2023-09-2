...
-- keys som kan bindas-- Vimspector options
vim.cmd([[
...
-- Telekasten
keymap("n", "<leader>wc", "<cmd>CalendarT<cr>", opts) -- Vimspector options
vim.cmd([[
let g:vimspector_sidebar_width = 85
let g:vimspector_bottombar_height = 15
let g:vimspector_terminal_maxwidth = 70
...
keymap('n', "DD", ":call vimspector#Launch()<cr>")
keymap('n', "DC", ":call vimspector#Reset()<cr>")
